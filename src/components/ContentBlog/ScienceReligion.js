...
const ScienceReligion = () => {
    ...
    return (
        <div>
            <h2 className="title">Are science and religion compatible?</h2>
            <p className="p">This topic is delicate to me, as a physics teacher I need to answer
                this type of question and mediate discussions in class.
            </p>
            <p className="p">
                ...
                contradictions inside the church.
            </p>
            <p className="p"> At the same time I started questioning religion, I was doing my degree in Physics.
            ...
            <p className="p">One day, my future master´s advisor in a subject called Elements and strategy
                ...
                hadn´t ever seen a philosophical discussion about this theme.
            </p>
            <p className="p">I Sympathize with Max Planck´s ideas. Science and religion are compatible
